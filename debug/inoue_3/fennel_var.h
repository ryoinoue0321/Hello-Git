...
# ifdef ADJUST_PARAM
              ...
              CASE ('idPvar(iK_NO3_1)')
                idPvar(iK_NO3_1)=varid
              CASE ('idPvar(iK_NH4_1)')
                idPvar(iK_NH4_1)=varid
              CASE ('idPvar(iK_Phy1)')
                idPvar(iK_Phy1)=varid
              CASE ('idPvar(iChl2C_m1)')
                idPvar(iChl2C_m1)=varid
              CASE ('idPvar(iPhyCN)')
                idPvar(iPhyCN)=varid
              CASE ('idPvar(iPhyIP)')
                idPvar(iPhyIP)=varid
              CASE ('idPvar(iPhyIS1)')
                idPvar(iPhyIS1)=varid
              CASE ('idPvar(iPhyMR)')
                idPvar(iPhyMR)=varid
              ...
              CASE ('idPvar(iK_PO4_1)')
                idPvar(iK_PO4_1)=varid
              CASE ('idPvar(iPhyPN)')
                idPvar(iPhyPN)=varid
              CASE ('idPvar(iZooPN)')
                idPvar(iZooPN)=varid
...
# endif
#ifdef SEABOTTOM_FLUX
              CASE ('idTbry(iwest,iFC)')
                idTbry(iwest,iFC)=varid
              CASE ('idTbry(ieast,iFC)')
                idTbry(ieast,iFC)=varid
              CASE ('idTbry(isouth,iFC)')
                idTbry(isouth,iFC)=varid
              CASE ('idTbry(inorth,iFC)')
                idTbry(inorth,iFC)=varid
#endif
