...
!
                ...
                Chl2C=MIN(Bio(i,k,iChlo1)/(Bio(i,k,iPhyt1)*cff+eps),      &
     &                    Chl2C_m(ng))
!
...
!
                fac1=dtdays*t_PPmax*Bio(i,k,iPhyt1)
...
!
              cff1=fac1*Bio(i,k,iZoop)*Bio(i,k,iPhyt1)/                  &
...
!
              N_Flux_Assim=Bio(i,k,iPhyt1)*cff1*ZooAE_N(ng)
              N_Flux_Egest=Bio(i,k,iPhyt1)*cff1*(1.0_r8-ZooAE_N(ng))
              Bio1(i,k,iZoop)=Bio(i,k,iZoop)
...
!
     ...
     &                       (PhyPN(ng)-ZooPN(ng))*N_Flux_Assim
          ...
          END DO
!
              Bio3(i,k,iPhyt1)=Bio(i,k,iPhyt1)
              Bio3(i,k,iPhyt1)=Bio(i,k,iChlo1)
!
...
!
          ...
          DO k=1,N(ng)
            DO i=Istr,Iend
              cff1=fac1*(Bio(i,k,iSDeN)+Bio(i,k,iPhyt1))
              cff2=1.0_r8/(1.0_r8+cff1)
              Bio(i,k,iPhyt1)=Bio(i,k,iPhyt1)*cff2
              Bio(i,k,iChlo1)=Bio(i,k,iChlo1)*cff2
              Bio(i,k,iSDeN)=Bio(i,k,iSDeN)*cff2
              N_Flux_CoagP=Bio(i,k,iPhyt1)*cff1
