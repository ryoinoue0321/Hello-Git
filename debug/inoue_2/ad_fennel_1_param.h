...
!>   &                           tl_cff3)/(1.0_r8+cff3)
              ...
              ad_cff3=ad_cff3-Bio3(i,k,iNO3_)*adfac
...
!>   &                            Bio(i,k,iNH4_)*tl_cff3
                ad_cff3=ad_cff3+Bio3(i,k,iNH4_)*ad_N_Flux_Nitrifi
...
!>   &                             tl_cff3)/(1.0_r8+cff3)
                ...
                ad_cff3=ad_cff3-Bio3(i,k,iNH4_)*adfac
...
!
                fac1=dtdays*t_PPmax*Bio2(i,k,iPhyt1)
...
!>              Bio(i,k,iNO3_)=Bio(i,k,iNO3_)/(1.0_r8+cff4)
!>              Bio(i,k,iNH4_)=Bio(i,k,iNH4_)/(1.0_r8+cff5)
                N_Flux_NewProd=Bio3(i,k,iNO3_)*cff4
                N_Flux_RegProd=Bio3(i,k,iNH4_)*cff5
#endif
...
!>              Bio(i,k,iChlo1)=Bio(i,k,iChlo1)+Bio(i,k,iChlo1)*fac3
#ifdef OXYGEN
!
!  Update oxygen
!
...
!>   &                            Bio1(i,k,iChlo1)*tl_fac3
                ad_fac3=ad_fac3+Bio2(i,k,iChlo1)*ad_Bio(i,k,iChlo1)
...
!>              tl_Bio(i,k,iPhyt1)=tl_Bio(i,k,iPhyt1)+                    &
!>   &                            tl_N_Flux_NewProd+tl_N_Flux_RegProd
                ad_N_Flux_RegProd=ad_N_Flux_RegProd+ad_Bio(i,k,iPhyt1)
                ad_N_Flux_NewProd=ad_N_Flux_NewProd+ad_Bio(i,k,iPhyt1)
!
!
!  Nitrate and ammonium uptake by Phytoplankton.
!
!               ========================================================
                cff1=Bio2(i,k,iNH4_)*K_NH4(ng)
                cff2=Bio2(i,k,iNO3_)*K_NO3(ng)
                fac2=cff2/(1.0_r8+cff2)
#ifdef PHOSPHORUS
                cff3=Bio2(i,k,iPO4_)*K_PO4(ng)
#endif
                fac1=dtdays*t_PPmax*Bio2(i,k,iPhyt1)
                fac4=fac1*K_NO3(ng)*inhNH4
                cff4=fac4/(1.0_r8+cff2)
...
!>   &                               tl_cff6)/(1.0_r8+cff6)
                  ...
                  ad_cff6=ad_cff6-Bio2(i,k,iPO4_)*adfac
...
!>              tl_fac1=dtdays*(tl_t_PPmax*Bio1(i,k,iPhyt1)+             &
!>   &                          t_PPmax*tl_Bio(i,k,iPhyt1))
                adfac=dtdays*ad_fac1
                ad_Bio(i,k,iPhyt1)=ad_Bio(i,k,iPhyt1)+t_PPmax*adfac
                ad_t_PPmax=ad_t_PPmax+Bio2(i,k,iPhyt1)*adfac
                ad_fac1=0.0_r8
!
!  Nutrient-limitation terms
!
...
!>              tl_fac1=tl_Bio(i,k,iPhyt1)*cff+Bio1(i,k,iPhyt1)*tl_cff
                ad_cff=ad_cff+Bio1(i,k,iPhyt1)*ad_fac1
                ad_Bio(i,k,iPhyt1)=ad_Bio(i,k,iPhyt1)+cff*ad_fac1
                ad_fac1=0.0_r8
...
!>   &                 fac1*(tl_z_w(i,j,k)-tl_z_w(i,j,k-1))
                ...
                ad_Att=0.0_r8
!
!>              tl_fac1=tl_AttSW+tl_AttChl*Bio1(i,k,iChlo1)+             &
!>   &                           AttChl(ng)*tl_Bio(i,k,iChlo1)
                ad_Bio(i,k,iChlo1)=ad_Bio(i,k,iChlo1)+AttChl(ng)*ad_fac1
                ad_AttChl=ad_AttChl+Bio1(i,k,iChlo1)*ad_fac1
...
!>              tl_fac2=(0.5_r8+SIGN(0.5_r8,Bio2(i,k,iOxyg)))*          &
!>   &                  tl_Bio(i,k,iOxyg)
                adfac=0.5_r8+SIGN(0.5_r8,Bio1(i,k,iOxyg))
                ad_Bio(i,k,iOxyg)=ad_Bio(i,k,iOxyg)+adfac*ad_fac2
                ad_fac2=0.0_r8
#else
!>              tl_cff3=tl_fac1
