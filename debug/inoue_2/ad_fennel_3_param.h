...
!
          ...
          DO k=1,N(ng)
            DO i=Istr,Iend
              cff1=fac1*(Bio1(i,k,iSDeN)+Bio1(i,k,iPhyt1))
              cff2=1.0_r8/(1.0_r8+cff1)
...
!>            Bio(i,k,iSDeN)=Bio(i,k,iSDeN)*cff2
              N_Flux_CoagP=Bio2(i,k,iPhyt1)*cff1
...
!>            tl_N_Flux_CoagP=tl_Bio(i,k,iPhyt1)*cff1+                   &
!>   &                        Bio2(i,k,iPhyt1)*tl_cff1
              ad_cff1=ad_cff1+Bio2(i,k,iPhyt1)*ad_N_Flux_CoagP
              ad_Bio(i,k,iPhyt1)=ad_Bio(i,k,iPhyt1)+ad_N_Flux_CoagP*cff1
...
!>            tl_Bio(i,k,iPhyt1)=tl_Bio(i,k,iPhyt1)*cff2+                 &
!>   &                          Bio1(i,k,iPhyt1)*tl_cff2
              ad_cff2=ad_cff2+Bio1(i,k,iPhyt1)*ad_Bio(i,k,iPhyt1)
              ad_Bio(i,k,iPhyt1)=ad_Bio(i,k,iPhyt1)*cff2

!>            tl_cff2=-cff2*cff2*tl_cff1
              ad_cff1=ad_cff1-cff2*cff2*ad_cff2
              ad_cff2=0.0_r8

!>            tl_cff1=tl_fac1*(Bio1(i,k,iSDeN)+Bio1(i,k,iPhyt1))+        &
!>   &                fac1*(tl_Bio(i,k,iSDeN)+tl_Bio(i,k,iPhyt1))
              adfac=fac1*ad_cff1
              ad_Bio(i,k,iPhyt1)=ad_Bio(i,k,iPhyt1)+adfac
              ad_Bio(i,k,iSDeN)=ad_Bio(i,k,iSDeN)+adfac
              ad_fac1=ad_fac1+(Bio1(i,k,iSDeN)+Bio1(i,k,iPhyt1))*ad_cff1
              ad_cff1=0.0_r8
            END DO
          END DO
