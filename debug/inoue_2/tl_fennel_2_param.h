...
!
!!            cff=Bio1(i,k,iPhyt1)/                                      &
!!   &            (K_Phy(ng)+Bio1(i,k,iPhyt1)*Bio1(i,k,iPhyt1))
...
! detritus.
!
!!            N_Flux_Assim=Bio2(i,k,iPhyt1)*cff1*ZooAE_N(ng)
...
!!            N_Flux_Egest=Bio2(i,k,iPhyt1)*cff1*(1.0_r8-ZooAE_N(ng))
...
!
!!            N_Flux_Pmortal=cff2*MAX(Bio(i,k,iPhyt1)-PhyMin(ng),0.0_r8)
...
!
          ...
          DO k=1,N(ng)
            DO i=Istr,Iend
!!            fac1=fac3*Bio(i,k,iPhyt1)*Bio(i,k,iPhyt1)/                  &
!!   &             (K_Phy(ng)+Bio(i,k,iPhyt1)*Bio(i,k,iPhyt1))
