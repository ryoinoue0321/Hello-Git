...
*/
              ...
              CASE ('idTbry(iwest,iPhyt1)')
                idTbry(iwest,iPhyt1)=varid
              CASE ('idTbry(ieast,iPhyt1)')
                idTbry(ieast,iPhyt1)=varid
              CASE ('idTbry(isouth,iPhyt1)')
                idTbry(isouth,iPhyt1)=varid
              CASE ('idTbry(inorth,iPhyt1)')
                idTbry(inorth,iPhyt1)=varid
