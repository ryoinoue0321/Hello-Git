...
!
          ...
          DO k=1,N(ng)
            DO i=Istr,Iend
              fac4=K_Phy(ng)+Bio(i,k,iPhyt1)*Bio(i,k,iPhyt1)
              fac5=fac3*Bio(i,k,iPhyt1)*Bio(i,k,iPhyt1)
              fac1=fac5/fac4
...
!>            tl_fac5=tl_fac3*Bio(i,k,iPhyt1)*Bio(i,k,iPhyt1)+            &
!>   &                fac3*2.0_r8*Bio(i,k,iPhyt1)*tl_Bio(i,k,iPhyt1)
              ad_Bio(i,k,iPhyt1)=ad_Bio(i,k,iPhyt1)+                      &
     &                          fac3*2.0_r8*Bio(i,k,iPhyt1)*ad_fac5
              ad_fac3=ad_fac3+Bio(i,k,iPhyt1)*Bio(i,k,iPhyt1)*ad_fac5
              ad_fac5=0.0_r8

!>            tl_fac4=tl_K_Phy+2.0_r8*Bio(i,k,iPhyt1)*tl_Bio(i,k,iPhyt1)
              ad_Bio(i,k,iPhyt1)=ad_Bio(i,k,iPhyt1)+                      &
     &                          2.0_r8*Bio(i,k,iPhyt1)*ad_fac4
...
!
              cff=MAX(Bio2(i,k,iPhyt1)-PhyMin(ng),0.0_r8)
              N_Flux_Pmortal=cff2*cff
!>            Bio2(i,k,iPhyt1)=Bio(i,k,iPhyt1)
!>            Bio2(i,k,iSDeN)=Bio(i,k,iSDeN)
!>            Bio(i,k,iPhyt1)=Bio(i,k,iPhyt1)-N_Flux_Pmortal
!>            Bio(i,k,iSDeN)=Bio(i,k,iSDeN)+N_Flux_Pmortal
              cff=MAX(Bio2(i,k,iChlo1)-ChlMin(ng),0.0_r8)
!>            Bio(i,k,iChlo1)=Bio(i,k,iChlo1)-cff2*cff
#ifdef PHOSPHORUS
...
!>            tl_Bio(i,k,iPhyt1)=tl_Bio(i,k,iPhyt1)-tl_N_Flux_Pmortal
              ad_N_Flux_Pmortal=ad_N_Flux_Pmortal-ad_Bio(i,k,iPhyt1)
...
!>            tl_cff=(0.5_r8+SIGN(0.5_r8,Bio2(i,k,iPhyt1)-PhyMin(ng)))*  &
!>   &               tl_Bio(i,k,iPhyt1)
              adfac=0.5_r8+SIGN(0.5_r8,Bio2(i,k,iPhyt1)-PhyMin(ng))
              ad_Bio(i,k,iPhyt1)=ad_Bio(i,k,iPhyt1)+adfac*ad_cff
              ad_cff=0.0_r8
!
! Phytoplankton assimilated to zooplankton and egested to small
! detritus.
...
!>            tl_fac4=tl_Bio(i,k,iPhyt1)*cff1+Bio2(i,k,iPhyt1)*tl_cff1
              ad_cff1=ad_cff1+Bio2(i,k,iPhyt1)*ad_fac4
              ad_Bio(i,k,iPhyt1)=ad_Bio(i,k,iPhyt1)+cff1*ad_fac4
              ad_fac4=0.0_r8
!
! Phytoplankton grazing by zooplankton.
!
...
!>            tl_Bio(i,k,iPhyt1)=tl_cff3*Bio1(i,k,iPhyt1)+                &
!>   &                          cff3*tl_Bio(i,k,iPhyt1)
              ad_cff3=ad_cff3+ad_Bio(i,k,iPhyt1)*Bio1(i,k,iPhyt1)
              ad_Bio(i,k,iPhyt1)=cff3*ad_Bio(i,k,iPhyt1)
...
!>            tl_cff=(tl_Bio(i,k,iPhyt1)-cff*tl_fac)/fac
              adfac=ad_cff/fac
              ad_fac=ad_fac-cff*adfac
              ad_Bio(i,k,iPhyt1)=ad_Bio(i,k,iPhyt1)+adfac
              ad_cff=0.0_r8

!>            tl_fac=tl_K_Phy+2.0_r8*Bio1(i,k,iPhyt1)*tl_Bio(i,k,iPhyt1)
              ad_Bio(i,k,iPhyt1)=ad_Bio(i,k,iPhyt1)+                      &
     &                          2.0_r8*Bio1(i,k,iPhyt1)*ad_fac
