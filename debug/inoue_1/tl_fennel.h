...
!
      ...
      real(r8) :: tl_Epp1, tl_L_NH4_1, tl_L_NO3_1, tl_LTOT1, tl_Vp1
      real(r8) :: tl_Chl2C1, tl_t_PPmax1, tl_inhNH4_1
      real(r8) :: tl_Att_T1, tl_Att_L1, tl_Att_N1


      real(r8) :: cff01, cff11, cff21, cff31, cff41, cff51, cff61
      real(r8) :: fac01, fac11, fac21, fac31, fac41, fac51, fac61

      real(r8) :: tl_cff01, tl_cff11, tl_cff21, tl_cff31, tl_cff41, tl_cff51, tl_cff61
      real(r8) :: tl_fac01, tl_fac11, tl_fac21, tl_fac31, tl_fac41, tl_fac51, tl_fac61
      ...
      real(r8) :: tl_N_Flux_Assim1
      real(r8) :: tl_N_Flux_CoagD1, tl_N_Flux_CoagP1
      real(r8) :: tl_N_Flux_Egest1
      real(r8) :: tl_N_Flux_NewProd1, tl_N_Flux_RegProd1
      real(r8) :: tl_N_Flux_Nitrifi1
      real(r8) :: tl_N_Flux_Pmortal1, tl_N_Flux_Zmortal1
      real(r8) :: tl_N_Flux_Remine1
      real(r8) :: tl_N_Flux_Zexcret1, tl_N_Flux_Zmetabo1
      real(r8) :: tl_N_Flux_Presp1
